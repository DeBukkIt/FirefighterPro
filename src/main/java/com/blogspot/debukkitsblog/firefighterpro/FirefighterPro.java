...
public class FirefighterPro extends JavaPlugin {
	...
	public void onEnable() {
		...
		try {
			...
			System.out.println("[FFPro] WorldGuard not found, working without WorldGuard support.");
		}
		
		if(setupEconomy()) {
			insurance = new Insurance();
		} else {
			System.out.println("[FFPro] Could not enable economy system, fire insurance and payment disabled.");
		}
	}
